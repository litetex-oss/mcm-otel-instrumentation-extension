...
## Releasing [![Build](https://img.shields.io/github/actions/workflow/status/litetex-oss/mcm-otel-monitoring-extension/release.yml?branch=master)](https://github.com/litetex-oss/mcm-otel-monitoring-extension/actions/workflows/release.yml)

Before releasing:
* Consider doing a [test-deployment](https://github.com/litetex-oss/mcm-otel-monitoring-extension/actions/workflows/test-deploy.yml?query=branch%3Adev) before actually releasing.
